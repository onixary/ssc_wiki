...
1. 合入了由 [MaxMobile-ru](https://github.com/MaxMobile-ru) 制作的俄语本地化
...
1. 蜘蛛形态
    ...
    “蛛丝”是蜘蛛形态的核心机制：发射蛛丝弹来构建可供攀爬的蛛网结构，以及阻碍敌人的行动。在形态后期还能获得更加强大的位移能力

    蜘蛛形态还会有额外的第二双手的饰品槽位，可以使用专属饰品/工具来进一步强化能力

2. 机制优化

    为信雅互联版本添加了Trinkets与原生Curios的兼容层，现在形态饰品可以直接被放进Curios栏位中

    幻形者之书的条目支持自动滚动文本，不再会因为文本过长而被截断

    添加了一些原版形态成就作为游戏内的指引

    添加了相关物品的原版配方解锁

    优化了蜘蛛形态与Feral形态的脚步声，让其更符合四条腿噼里啪啦的行动模式

3. Bug修复

    修复了蜘蛛形态缺失音效以及缺少夜视能力的bug，以及相关的多个问题

    让咒文蜘蛛在有光照时保持中立，与原版蜘蛛同步
...
1. 全新的形态可视交互调色菜单
    ...
    现在，游戏中加入了一个全新的可视交互调色菜单，你可以通过RGB滑动条等多种方式精细地调整形态颜色，并实时预览调色结果，再也不用一个一个试Hex颜色了！

    你可以在幻形者之书新添加的按钮处，以及mod配置菜单(需要安装Mod Menu)中打开调色菜单

2. 合入了由 [MaxMobile-ru](https://github.com/MaxMobile-ru) 制作的最新俄语本地化。非常感谢！
